...
with(this){return _c('p',[_v("The list transactions command allows for users to view all transactions for the specified person. Notably, when the command is used, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#updateFilteredPersonList()")]),_v(" is called to update the person list to just contain that specified person. It also implements the following operations:")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#setIsViewTransactions(boolean)")]),_v(" — Displays the person list in the GUI when false, and displays the transactions list in the GUI when true.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#updateTransactionList(ObservableList<Transaction>)")]),_v(" — Updates the transaction list to contain transactions for the specified person.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("As a result of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("listt INDEX")]),_v(" changing the person list, operations on the transactions (e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletet")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("summary")]),_v(") can now be performed on the transactions list, without specifying the person index.")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Overload "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("listt")]),_v(" to not take in an index in transaction list view, to view the whole transactions list for the selected person.")])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Sat, 9 Nov 2024, 23:20:52 GMT+8]")])])])}
}];
