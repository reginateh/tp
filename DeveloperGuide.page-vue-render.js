...
with(this){return _c('h3',{attrs:{"id":"find-transactions-findt-index-keyword-keywords"}},[_v("Find Transactions "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findt INDEX KEYWORD [KEYWORDS]")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#find-transactions-findt-index-keyword-keywords","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("When the command is used, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#updateTransactionList()")]),_v(" is called to update the transaction list to the transactions of the specified person.\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#updateFilteredPersonList()")]),_v(" is called to update the person list to just contain that specified person.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The following sequence diagram shows an example execution of command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findt 1 ...")]),_v(", where "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v(" represents any number of keywords.")])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"side-effects-2"}},[_v("Side Effects"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#side-effects-2","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Same as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("listt")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findt")]),_v(" also changes the person list to preserve the setting that the only person in the person list is the specified person whose transactions are currently shown.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("As a result, operations on the transactions (e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletet")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("summary")]),_v(") can be performed on the transactions list, without specifying the person index, regardless of the transaction list being generated from "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("listt")]),_v(" or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findt")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Thu, 24 Oct 2024, 18:25:52 GMT+8]")])])])}
}];
